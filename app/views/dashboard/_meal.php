<tbody data-id="<?php echo $meal->id; ?>">
	<tr class="meal">
		...
		<th class="number"><?php echo $meal->registrations->count(); ?></th>
		<th>
    ...
    <tr class="new_registration">
        <td>&nbsp;</td>
        <td>
            <input type="text" name="name" placeholder="Nieuwe aanmelding" value="" />
        </td>
        <td>
            <input type="text" name="handicap" placeholder="handicap" value="" />
        </td>
        <td><input type="submit" value="+" /></td>
        <td colspan=3>&nbsp;</td>
    </tr>
    
    <?php foreach ($meal->registrations()->get() as $registration): ?>
