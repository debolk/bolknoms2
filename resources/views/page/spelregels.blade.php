...
@section('content')
    ...
    <ol>
        ...
        <li>Als je niet op tijd afmeldt en niet komt opdagen, moet je wel voor de maaltijd betalen (meestal &euro;4,40). Er is immers wel voor je gekookt. Voor leden gaat dat op Bolkrekening, externen krijgen een factuur gemaild.</li>
    </ol>
@endsection
